    ...
    <form action="{{ route('productos.update', [$producto->id], false) }}" method="POST"
        ...
        <div class="mb-6">
            ...
            <select type="text" name="categoria_id" id="categoria_id" value="{{ old('$producto->categoria->denominacion', $producto->categoria_id)}}">
                    <option selected value="{{$producto->categoria_id}}">{{$producto->categoria->denominacion}}</option>
                    <option>----------</option>
        ...
        <div class="mb-6">
            ...
            <select type="text" name="estado_id" id="estado_id" value="{{ old('$producto->estado->tipo', $producto->estado_id)}}">
                <option selected value="{{$producto->estado_id}}">{{$producto->estado->tipo}}</option>
                <option>----------</option>
